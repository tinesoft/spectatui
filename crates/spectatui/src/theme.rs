...
impl Theme {
    pub fn new(mode: ThemeMode, accent: Accent) -> Self {
        let (bg, panel, panel_alt, fg, dim, faint, border, sel, sel_fg, good, warn, bad, info, header_bg) =
            match mode {
                ThemeMode::Dark => (
        ...
        Theme {
            ...
            title_focused: Style::default().fg(accent_color).add_modifier(Modifier::BOLD),
            ...
            accent_bold: Style::default().fg(accent_color).add_modifier(Modifier::BOLD),
    ...
    pub fn stage_badge(&self, label: &str, mode: ThemeMode) -> Style {
        let (fg_color, bg_color) = match (label, mode) {
            ("cons", ThemeMode::Dark) => (Color::Rgb(0x7f, 0xd8, 0xc2), Color::Rgb(0x0f, 0x3a, 0x32)),
            ("cons", ThemeMode::Light) => (Color::Rgb(0x0b, 0x60, 0x52), Color::Rgb(0xcf, 0xee, 0xe6)),
            ("spec", ThemeMode::Dark) => (Color::Rgb(0xf0, 0xa4, 0x7c), Color::Rgb(0x43, 0x21, 0x0f)),
            ("spec", ThemeMode::Light) => (Color::Rgb(0xa5, 0x51, 0x2b), Color::Rgb(0xf6, 0xdd, 0xcf)),
            ("clar", ThemeMode::Dark) => (Color::Rgb(0xe8, 0xa6, 0xc5), Color::Rgb(0x3d, 0x1b, 0x2d)),
            ("clar", ThemeMode::Light) => (Color::Rgb(0x9c, 0x3a, 0x68), Color::Rgb(0xf4, 0xd9, 0xe6)),
            ("plan", ThemeMode::Dark) => (Color::Rgb(0xf0, 0xc8, 0x79), Color::Rgb(0x42, 0x33, 0x0c)),
            ("plan", ThemeMode::Light) => (Color::Rgb(0x8a, 0x63, 0x10), Color::Rgb(0xf3, 0xe7, 0xc4)),
            ("task", ThemeMode::Dark) => (Color::Rgb(0x86, 0xb8, 0xec), Color::Rgb(0x10, 0x31, 0x4f)),
            ("task", ThemeMode::Light) => (Color::Rgb(0x2d, 0x6b, 0xa3), Color::Rgb(0xd6, 0xe7, 0xf6)),
            ("anly", ThemeMode::Dark) => (Color::Rgb(0xc4, 0xa7, 0xf0), Color::Rgb(0x2c, 0x1f, 0x47)),
            ("anly", ThemeMode::Light) => (Color::Rgb(0x5d, 0x3a, 0xa0), Color::Rgb(0xe7, 0xdd, 0xf6)),
            ("impl", ThemeMode::Dark) => (Color::Rgb(0x90, 0xd8, 0x90), Color::Rgb(0x12, 0x3a, 0x1d)),
            ("impl", ThemeMode::Light) => (Color::Rgb(0x2f, 0x8a, 0x3f), Color::Rgb(0xd4, 0xee, 0xd9)),
